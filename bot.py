    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/hshshshswgwg")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/+mRTkZS34lxowZjM1"),
                        InlineKeyboardButton("YouTube Channel", url="https://youtube.com/@youtuberking21?si=WGSOv9Snki0Zj2tI")
                    ]
                ]
            )
        )
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://youtube.com/@youtuberking21?si=WGSOv9Snki0Zj2tI")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/+mRTkZS34lxowZjM1).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/+mRTkZS34lxowZjM1).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
